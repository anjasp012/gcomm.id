    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
        ...
        <div class="md:col-span-5 flex justify-center">
            <div class="relative w-64 h-80 rounded-2xl bg-white border border-slate-200/80 shadow-xl flex flex-col justify-between p-8 overflow-hidden group hover:-translate-y-2 transition-transform duration-300">
                ...
                <a href="{{ asset('documents/COMPANY PROFILE GCOMM.ID.pdf') }}" target="_blank" class="w-full text-center py-3 bg-[#ea4335] text-white text-xs font-semibold uppercase tracking-wider rounded-xl hover:bg-[#d63225] transition-colors">
                    Preview PDF
                </a>
            </div>
        </div>
        ...
        <div class="md:col-span-7 flex flex-col gap-6">
            ...
            <div class="flex flex-col sm:flex-row gap-4 mt-4">
                <a href="{{ asset('documents/COMPANY PROFILE GCOMM.ID.pdf') }}" target="_blank" class="inline-flex items-center justify-center gap-3 px-8 py-4 rounded-full text-sm font-semibold uppercase tracking-wider text-white bg-accent hover:bg-[#035ab2] transition-colors shadow-lg hover:shadow-xl">
                    <!-- Download SVG Icon -->
