...
<section class="py-24 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 animate-fade-in mb-12">
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 items-center">
        ...
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2018/10/1522126693_Kemlu-150x150.jpg" alt="Ministry of Foreign Affairs" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <!-- Kominfo -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2018/10/1522124379_Kominfo-150x150.jpg" alt="Kementerian Kominfo" class="max-h-16 w-auto object-contain transition-all duration-300">
            <span class="text-[10px] text-slate-400 mt-2 font-medium text-center hidden group-hover:block transition-all">Kemkominfo</span>
        </div>
        <!-- OJK -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2018/10/1522124468_OJK-150x150.jpg" alt="OJK" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <!-- KPU -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2018/10/1522126884_KPU-150x150.jpg" alt="KPU" class="max-h-16 w-auto object-contain transition-all duration-300">
            <span class="text-[10px] text-slate-400 mt-2 font-medium text-center hidden group-hover:block transition-all">KPU RI</span>
        </div>
        <!-- SKK Migas -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522121788_SKK_Migas-150x150.jpg" alt="SKK Migas" class="max-h-16 w-auto object-contain transition-all duration-300">
            <span class="text-[10px] text-slate-400 mt-2 font-medium text-center hidden group-hover:block transition-all">SKK Migas</span>
        </div>
        <!-- Kemendikbud -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522816177_Kemendikbud-150x150.jpg" alt="Kemendikbud" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <!-- BKKBN -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522829300_BKKBN-1-150x150.jpg" alt="BKKBN" class="max-h-16 w-auto object-contain transition-all duration-300">
            <span class="text-[10px] text-slate-400 mt-2 font-medium text-center hidden group-hover:block transition-all">BKKBN</span>
        </div>
        <!-- KKP -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522816425_KKP-150x150.jpg" alt="KKP" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <!-- Kemenpar -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522814774_Kemenpar-150x150.jpg" alt="Kemenpar" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <!-- Kementan -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522814151_Kementan-150x150.jpg" alt="Kementan" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <!-- Kemenpora -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522813992_Kemenpora-150x150.jpg" alt="Kemenpora" class="max-h-16 w-auto object-contain transition-all duration-300">
            <span class="text-[10px] text-slate-400 mt-2 font-medium text-center hidden group-hover:block transition-all">Kemenpora</span>
        </div>
        <!-- Kemenag -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522121910_Kemenag-150x150.jpg" alt="Kemenag" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <!-- BNPB -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1543229537_BNPB_logo-150x150.jpg" alt="BNPB" class="max-h-16 w-auto object-contain transition-all duration-300">
            <span class="text-[10px] text-slate-400 mt-2 font-medium text-center hidden group-hover:block transition-all">BNPB</span>
        </div>
        <!-- BKPM -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2018/10/1522117629_BKPM-150x150.png" alt="BKPM" class="max-h-16 w-auto object-contain transition-all duration-300">
            <span class="text-[10px] text-slate-400 mt-2 font-medium text-center hidden group-hover:block transition-all">BKPM</span>
        </div>
        <!-- BP3TI -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522119563_BP3TI-150x150.png" alt="BP3TI" class="max-h-16 w-auto object-contain transition-all duration-300">
            <span class="text-[10px] text-slate-400 mt-2 font-medium text-center hidden group-hover:block transition-all">BP3TI</span>
        </div>
        <!-- IPB University -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2018/10/1522126581_IPB-150x150.jpg" alt="IPB University" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <!-- Bank Mandiri -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522118538_Bank_Mandiri-150x150.png" alt="Bank Mandiri" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <!-- BRI -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522817676_BRI-150x150.jpg" alt="Bank BRI" class="max-h-16 w-auto object-contain transition-all duration-300">
            <span class="text-[10px] text-slate-400 mt-2 font-medium text-center hidden group-hover:block transition-all">Bank BRI</span>
        </div>
        <!-- BNI -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522816953_BNI-150x150.jpg" alt="Bank BNI" class="max-h-16 w-auto object-contain transition-all duration-300">
            <span class="text-[10px] text-slate-400 mt-2 font-medium text-center hidden group-hover:block transition-all">Bank BNI</span>
        </div>
        <!-- Sumitomo Bank -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522815740_Sumito_Bank-150x150.jpg" alt="Sumitomo Bank" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <!-- AXA Mandiri -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522830433_AXA_Mandiri-150x150.jpg" alt="AXA Mandiri" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <!-- Petronas -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522830055_Petronas-150x150.jpg" alt="Petronas" class="max-h-16 w-auto object-contain transition-all duration-300">
            <span class="text-[10px] text-slate-400 mt-2 font-medium text-center hidden group-hover:block transition-all">Petronas</span>
        </div>
        <!-- PHE ONWJ -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522830226_PHE_ONWJ-150x150.jpg" alt="PHE ONWJ" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <!-- Timah -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522135460_Timah-150x150.jpg" alt="PT Timah" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <!-- Semen Indonesia -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522127308_Semen_Indonesia-150x150.jpg" alt="Semen Indonesia" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <!-- Indosat Ooredoo -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522813792_Indosat-150x150.jpg" alt="Indosat Ooredoo" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <!-- Agung Podomoro Land -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522135241_Agung_Podomoro-150x150.jpg" alt="Agung Podomoro Land" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <!-- Korindo -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522135322_Korindo-150x150.jpg" alt="Korindo Group" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <!-- JICT -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522122287_JICT-150x150.jpg" alt="JICT" class="max-h-16 w-auto object-contain transition-all duration-300">
            <span class="text-[10px] text-slate-400 mt-2 font-medium text-center hidden group-hover:block transition-all">JICT</span>
        </div>
        <!-- CFLD -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522135241_Agung_Podomoro-150x150.jpg" alt="CFLD" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <!-- Artha Graha Network -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2018/10/1522117423_Arta_Graha-150x150.png" alt="Artha Graha Network" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <!-- KAA 2015 -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522815066_KAA_2015-150x150.jpg" alt="Asian-African Summit 2015" class="max-h-16 w-auto object-contain transition-all duration-300">
            <span class="text-[10px] text-slate-400 mt-2 font-medium text-center hidden group-hover:block transition-all">KAA 2015</span>
        </div>
        <!-- Indonesia Baik -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522135136_Indonesia_Baik-150x150.jpg" alt="Indonesia Baik" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <!-- Demi Indonesia -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522133075_Demi_Indonesia-150x150.jpg" alt="Demi Indonesia" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <!-- ICMI -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1497941016_icmi-150x125.jpg" alt="ICMI" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522136847_Dahlan-150x150.jpg" alt="Dahlan Iskan Initiative" class="max-h-16 w-auto object-contain transition-all duration-300">
        ...
        <!-- JIS -->
        <div class="glass p-3 rounded-2xl bg-white flex flex-col items-center justify-center h-32 group">
            <img src="https://gcomm.id/wp-content/uploads/2019/04/1522127023_JIS-150x150.jpg" alt="JIS" class="max-h-16 w-auto object-contain transition-all duration-300">
