    ...
    <div>
        ...
        <div x-show="activeTab === 'social'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0" class="flex flex-col gap-8">
            ...
            <div class="glass p-8 sm:p-12 rounded-3xl bg-white grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div class="lg:col-span-5 grid grid-cols-2 gap-4">
                    <a href="https://www.instagram.com/kemhanri/" target="_blank" class="block overflow-hidden rounded-2xl shadow hover:scale-105 transition-all duration-300">
                        <img src="https://images.unsplash.com/photo-1579710039144-85d6bdffddc9?q=80&w=600" alt="Kemhan RI 1" class="w-full h-full object-cover aspect-square">
                    </a>
                    <a href="https://www.instagram.com/kemhanri/" target="_blank" class="block overflow-hidden rounded-2xl shadow hover:scale-105 transition-all duration-300">
                        <img src="https://images.unsplash.com/photo-1507679799987-c73779587ccf?q=80&w=600" alt="Kemhan RI 2" class="w-full h-full object-cover aspect-square">
                    </a>
                    <a href="https://www.instagram.com/kemhanri/" target="_blank" class="block overflow-hidden rounded-2xl shadow hover:scale-105 transition-all duration-300">
                        <img src="https://images.unsplash.com/photo-1524178232363-1fb2b075b655?q=80&w=600" alt="Kemhan RI 3" class="w-full h-full object-cover aspect-square">
                    </a>
                    <a href="https://www.instagram.com/kemhanri/" target="_blank" class="block overflow-hidden rounded-2xl shadow hover:scale-105 transition-all duration-300">
                        <img src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=600" alt="Kemhan RI 4" class="w-full h-full object-cover aspect-square">
                    </a>
                </div>
            </div>
